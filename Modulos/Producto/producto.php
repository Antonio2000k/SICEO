                             ...
                             <div class="x_panel">
                                ...
                                <div class="x_content">
                                  ...
                                  <tbody id="imprimir">
                                    <?php
                                          include("../../Config/conexion.php");
                                          $query_s= pg_query($conexion, "select * from productos order by cmodelo");
                                          while($fila=pg_fetch_array($query_s)){
                                      ?>
                                    <tr>
...
if($bandera=="add"){
    ...
    pg_query("BEGIN");  
          $result=pg_query($conexion,"insert into productos(cmodelo, cnombre, estock, rprecio_compra, ccolor, rprecio_venta, 
            eid_garantia, eid_proveedor, eid_marca) values('$modelo','$nombre','0','$precioC','$color','$precioV','$garantia','$proveedor','$marca')");
          if(!$result){
                    pg_query("rollback");
