...
if(isset($_REQUEST["id"])){
  include("../../Config/conexion.php");
    $iddatos = $_REQUEST["id"];
    $query_s = pg_query($conexion, "select * from proveedor where cid_proveedor=$iddatos");
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <ul id="myTab" class="nav nav-tabs bar_tabs " role="tablist" >
                        <li role="presentation" class="active col-md-3 col-sm-3 col-xs-3"><a class="col-md-12 col-sm-12 col-xs-12" style="text-align: center" href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">NUEVO PROVEEDOR</a>
                        </li>
        ...
        mensajeInformacion('Error','Correo ya se encuentra registrado','error');
          ...
          if(!$result){
                    ...
                    mensajeInformacion('Error','Datos no almacenados','error');
                        ...
                        echo "alertaSweet('Error!','Complete !','error');";
    ...
    pg_query("BEGIN");
      if(validaCorreo($correo,$baccion)){
        ...
        mensajeInformacion('Error','Datos no almacenados','error');
          ...
          pg_query("commit");
                    echo "<script type='text/javascript'>";
                    echo "alertaSweet('Error!','Complete lo!','error');";
    ...
    $result=pg_query($conexion,"update proveedor set bestado='$estado' where eid_proveedor='$baccion'");      
      if(!$result){
        ...
        mensajeInformacion('Error','Datos no almacenados','error');
          ...
          pg_query("commit");
                echo "<script type='text/javascript'>";
                    echo "alertaSweet('Error!','Complete los !','error');";
