...
if($_SESSION['autenticado2']!="yeah" || $t!=2  ){
                                  ...
                                  <div class="col-md-5 col-sm-4 col-xs-12 form-group has-feedback">
                                    <div class="col-sm-3">
                                      <label style="text-align: justify;" class="control-label col-md-3 col-sm-4 col-xs-12">Sexo*</label>
                                       ...
                                       <div class="col-sm-3">
                                          <label>Masculino</label>  <input type="radio" class="flat" name="genero" id="generoM" value="M" disabled="disabled" checked="" <?php if ($Rsexo == "M") echo "checked"; ?>/>
                                       </div>
                                       <div class="col-sm-3">
                                           <label>Femenino</label>  <input type="radio" class="flat" name="genero" id="generoF" value="F" disabled="disabled" <?php if ($Rsexo == "F") echo "checked"; ?> />
                                       </div>
                                  </div>
                                  ...
                                  <div class="col-md-5 col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control has-feedback-left" id="edad" name="edad"    aria-describedby="inputSuccess2Status" style="padding-left: 55px;" readonly="readonly" placeholder="Edad" value="<?php
                                                if($Redad==1){
                                                  echo $Redad  ." "."año";
                                                }else{
                                                  echo $Redad  ." "."años";
                                 ...
                                 <div class="ln_solid"></div>
                                  ...
                                  <div class="item form-group">
                                    ...
                                    <div class="col-md-5 col-sm-6 col-xs-12 form-group has-feedback">
                                       <input type="tel" class="form-control has-feedback-left"  id="telefono" class="form-control  col-md-7 col-xs-12" readonly="readonly" data-validate-length-range="8,20" data-validate-words="2" name="telefono" placeholder="Telefono" data-inputmask="'mask': '9999-9999'" value="<?php echo $Rtelefono; ?>" autocomplete="off" onblur="vali('telefono');">
                                    ...
                                    <label class="control-label col-md-1 col-sm-3 col-xs-12">Direcci&oacuten*</label>
                                            <div class="col-md-11 col-sm-6 col-xs-12 form-group has-feedback">
                                                <input type="tel" class="form-control has-feedback-left" id="direccion" class="form-control col-md-7 col-xs-12" data-validate-length-range="8,20" data-validate-words="2" name="direccion" readonly="readonly" placeholder="Direccion" value="<?php echo $Rdireccion; ?>" autocomplete="off">
