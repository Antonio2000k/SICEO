...
<html lang="en">
  <head>
    ...
    <title>SICEO | Registrar Proveedor </title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <ul id="myTab" class="nav nav-tabs bar_tabs " role="tablist" >
                        <li role="presentation" class="active col-md-3 col-sm-3 col-xs-3"><a class="col-md-12 col-sm-12 col-xs-12" style="text-align: center" href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">REGISTRAR PROVEEDOR</a>
                        </li>
                        <li class="col-md-4 col-sm-3 col-xs-3" role="presentation" class="">
                          <a class="col-md-12 col-sm-12 col-xs-12" style="text-align: center" href="proveedora.php"  id="profile-tab"  aria-expanded="false">LISTA DE PROVEEDORES ACTIVOS</a>
                        </li>
                        <li class="col-md-4 col-sm-3 col-xs-3" role="presentation" class="">
                          <a class="col-md-12 col-sm-12 col-xs-12" style="text-align: center" href="proveedori.php" id="profile-tab2"  aria-expanded="false">LISTA DE PROVEEDORES INACTIVOS</a>
                        </li>
                  </ul>
                            ...
                            <div class="row">
                                    <div class="row">
                                      ...
                                      <div class="item form-group">
                                       ...
                                       <div class="item form-group"> 
                                        <label class="control-label col-md-1 col-sm-2 col-xs-12">Correo*</label>
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12 form-group has-feedback">
                                              <input type="tel" class="form-control has-feedback-left"  id="direccion" class="form-control col-md-7 col-xs-12" data-validate-length-range="8,20" data-validate-words="2" name="direccion" placeholder="Direccion de la Empresa" value="<?php echo $Rdireccion?>" autocomplete="off" onblur="vali('direccion');">
                                              <span class="fa fa-home form-control-feedback left" aria-hidden="true"></span>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                          ...
                                          <div class="col-md-5 col-sm-6 col-xs-12 form-group has-feedback">
                                              <input type="text" class="form-control has-feedback-left"  id="nombre" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nombre" placeholder="Nombre del Proveedor" value="<?php echo $Rnombre; ?>" onkeypress="return soloLetras(event)" autocomplete="off" onblur="vali('nombre');">
                                              <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                            </div>
                                            ...
                                            <div class="col-md-5 col-sm-6 col-xs-12 form-group has-feedback">
                                              <input type="text" class="form-control has-feedback-left"  id="apellido" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="apellido" placeholder="Apellidos del Proveedor" value="<?php echo $Rapellido; ?>" onkeypress="return soloLetras(event)" autocomplete="off" onblur="vali('apellido');">
                                              <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
