...
require 'Config/conexion.php';
	...
	while($row=pg_fetch_assoc($query_s)){	
		...
		$pdf->SetX(7); 
		$pdf->SetFillColor(255,255,255);
		$pdf->Cell(60,16,'Alexander Enmanuel Orellana Corvera',1,0,'C',1);
		$pdf->Cell(10,16,'M',1,0,'C',1);
		$pdf->Cell(75,16,'Av. Crescencio Miranda #2, 40mts al Sur del ',1,0,'C',1);
		$pdf->Cell(20,16,'2345 - 16965',1,0,'C',1);
		$pdf->Cell(20,16,'11/06/19916',1,1,'C',1);
	$pdf->SetX(7); 
		$pdf->SetFillColor(255,255,255);
		$pdf->Cell(60,16,'Alexander Enmanuel Orellana Corvera',1,0,'C',1);
		$pdf->Cell(10,16,'M',1,0,'C',1);
		...
		$pdf->Cell(75,16,'Av. Crescencio Miranda #2, 40mts al Sur del ',1,0,'C',1);
		$pdf->Cell(20,16,'2345 - 16965',1,0,'C',1);
		$pdf->Cell(20,16,'11/06/1998',1,1,'C',1);	
	}
