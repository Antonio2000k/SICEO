                  ...
                  <div class="" data-example-id="togglable-tabs" role="tabpanel">
                    <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                       <li class="" role="presentation">
                          <a aria-expanded="false"  href="ventas.php" id="profile-tab">
                            REGISTRAR VENTA
                          </a>
                        </li>
                              ...
                              <tbody id="recargarListaVentas">
                                ...
                                <tr>
                                  ...
                                  <td class="text-center">
                                    ...
                                    ?>
                                    <button class="btn btn-success btn-icon left-icon" onclick="abonarCuenta(<?php echo $restante ?>)"> <i class="fa fa-money"></i> <span></span></button>
