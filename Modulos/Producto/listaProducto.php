                    ...
                    <div class="x_content" id="imprimirTablaActivados">
                      ...
                      ?>
                        ...
                        <td class="text-center">
                            ...
                            ?>
                            <button class="btn btn-success btn-icon left-icon" data-toggle="modal" data-target="#exampleModal" onclick="ActualizarModalOCombo('<?php echo $fila[0]; ?>','modal','cargala')"> <i class="fa fa-list-ul"></i></button>
                        </td>
                </tr>
                        <?php
                      }
