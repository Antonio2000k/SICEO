  ...
  <div class="modal-dialog" role="document">
    ...
    <form class="form-horizontal form-label-left" id="formProductoM" name="formProductoM" method="post">
        ...
        <div class="item form-group col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">                                    
                        <input type="text" class="form-control has-feedback-left" id="nombreP" class="form-control col-md-7 col-xs-12" name="nombreP" placeholder="Ingrese el nombre" autocomplete="off" onblur="verificarCodigo('nombre')"> <span class="fa fa-toggle-right form-control-feedback left" aria-hidden="true"></span>                       
                </div>
        </div>    
        <div class="item form-group col-md-12 col-sm-12 col-xs-12">
