                         ...
                         <div class="modal-header">
                           <div style="float: right; color: red">
                             ...
                             <div class="x_title" style="background: linear-gradient(to top,#000104d6 0,#03016b 50%)">
                               <h5 align="center" style=" color: white">ASISTENCIA COMPRAS AL CONTADO</h5>
                               <div class="clearfix"></div>
                             </div>
                         </div>
                           ...
                           <div id="carousel-example-generic" class="carousel slide" data-interval="false" data-ride="carousel" >
                             ...
                             <div class="carousel-inner">
                               <div class="item active">
                                 <img class="img-responsive" src="../Ayuda/Compras/compra9.png" alt="...">
                                 <div class="carousel-caption" style="margin-bottom:0px;">
                                   <p style="color:black";> En esta pantalla se muestran listadas todas slas compras hechas al contado. </p>
                                 </div>
                               </div>

                               <div class="item ">
                                 <img class="img-responsive" src="../Ayuda/Compras/compra10.png" alt="...">
                                 <div class="carousel-caption">
                                   <p style="color:black";>Si pulsamos el boton de la columna ver mas nos carga el listado de los productos adquiridos en esa compra. </p>
                                 </div>
                               </div>
                             </div>
